...
pub fn asl_a(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.a_reg_size() {
...
pub fn clc(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    cpu.status.set_carry(false);
}

pub fn cld(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    cpu.status.set_decimal(false);
}

pub fn cli(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    cpu.status.set_irq_disable(false);
}

pub fn clv(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
...
pub fn dec_a(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.a_reg_size() {
...
pub fn dex(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.index_regs_size() {
...
pub fn dey(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.index_regs_size() {
...
pub fn inc_a(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.a_reg_size() {
...
pub fn inx(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.index_regs_size() {
...
pub fn iny(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.index_regs_size() {
...
pub fn lsr_a(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.a_reg_size() {
...
pub fn nop(_cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
}
...
pub fn rol_a(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.a_reg_size() {
...
pub fn ror_a(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.a_reg_size() {
...
pub fn sec(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    cpu.status.set_carry(true);
}

pub fn sed(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    cpu.status.set_decimal(true);
}

pub fn sei(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
...
pub fn stp(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    cpu.stopped = true;
    bus.add_io_cycles(2);
}
...
pub fn tax(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.index_regs_size() {
...
pub fn tay(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.index_regs_size() {
        let value = cpu.accumulator as u8;
        cpu.set_nz(value);
...
pub fn tcd(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    cpu.dpr = cpu.accumulator;
    cpu.set_nz(cpu.accumulator);
}

pub fn tcs(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    //todo in emulation mode only 8bit are transferred
    bus.add_io_cycles(1);
    cpu.stack_pointer = cpu.accumulator;
}

pub fn tdc(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
...
pub fn tsc(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    cpu.accumulator = cpu.stack_pointer;
    cpu.set_nz(cpu.stack_pointer);
}

pub fn tsx(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.index_regs_size() {
...
pub fn txa(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.a_reg_size() {
...
pub fn txs(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    //todo in emulation mode only 8bit are transferred
    bus.add_io_cycles(1);
    cpu.stack_pointer = cpu.index_x;
}

pub fn txy(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.index_regs_size() {
        let value = cpu.index_x as u8;
        cpu.set_nz(value);
...
pub fn tya(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.a_reg_size() {
...
pub fn tyx(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
    if cpu.status.index_regs_size() {
        let value = cpu.index_y as u8;
        cpu.set_nz(value);
...
pub fn wai(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(2);
...
pub fn xba(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(2);
    cpu.accumulator = cpu.accumulator.swap_bytes();
    cpu.set_nz(cpu.accumulator as u8);
}

pub fn xce(cpu: &mut Cpu, bus: &mut Bus, _mode: AddressingMode) {
    bus.add_io_cycles(1);
