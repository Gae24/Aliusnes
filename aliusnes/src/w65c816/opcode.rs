...
#[cfg(feature = "trace")]
impl Meta {
    pub(crate) fn disasm_opcode<B: Bus>(&self, bus: &B, addr: Address) -> String {
        let operand = match self.mode.operand_size() {
            0 => 0,
        ...
        match self.mode {
            ...
            AddressingMode::Relative => format!("{} ${:04X}", self.mnemonic, operand),
            AddressingMode::RelativeLong => format!("{} ${:06X}", self.mnemonic, operand),
            AddressingMode::Direct => format!("{} ${:02X}", self.mnemonic, operand),
            AddressingMode::DirectX => format!("{} ${:02X},X", self.mnemonic, operand),
            AddressingMode::DirectY => format!("{} ${:02X},Y", self.mnemonic, operand),
            AddressingMode::Indirect => format!("{} (${:02X})", self.mnemonic, operand),
            AddressingMode::IndirectX => format!("{} (${:02X},X)", self.mnemonic, operand),
            AddressingMode::IndirectY => format!("{} (${:02X}),Y", self.mnemonic, operand),
            AddressingMode::IndirectLong => format!("{} [${:02X}]", self.mnemonic, operand),
            AddressingMode::IndirectLongY => format!("{} [${:02X}],Y", self.mnemonic, operand),
            ...
            AddressingMode::AbsoluteLong => format!("{} ${:06X}", self.mnemonic, operand),
            AddressingMode::AbsoluteLongX => format!("{} ${:06X},X", self.mnemonic, operand),
            AddressingMode::AbsoluteIndirect => format!("{} (${:04X})", self.mnemonic, operand),
            AddressingMode::AbsoluteIndirectLong => format!("{} [${:04X}]", self.mnemonic, operand),
            AddressingMode::AbsoluteIndirectX => format!("{} (${:04X},X)", self.mnemonic, operand),
