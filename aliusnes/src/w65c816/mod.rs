...
pub const fn opcode_table<B: Bus>() -> [OpCode<B>; 256] {
    ...
    [
        ...
        OpCode::new(Meta::new(0x0a, "ASL", Implied), W65C816::asl_a),
        ...
        OpCode::new(Meta::new(0x1a, "INC", Implied), W65C816::inc_a),
        ...
        OpCode::new(Meta::new(0x20, "JSR", AbsoluteJMP), W65C816::jsr),
        OpCode::new(Meta::new(0x21, "AND", IndirectX), W65C816::and),
        OpCode::new(Meta::new(0x22, "JSL", AbsoluteLongJSL), W65C816::jsl),
        ...
        OpCode::new(Meta::new(0x2a, "ROL", Implied), W65C816::rol_a),
        ...
        OpCode::new(Meta::new(0x3a, "DEC", Implied), W65C816::dec_a),
        ...
        OpCode::new(Meta::new(0x4a, "LSR", Implied), W65C816::lsr_a),
        OpCode::new(Meta::new(0x4b, "PHK", Implied), W65C816::phk),
        OpCode::new(Meta::new(0x4c, "JMP", AbsoluteJMP), W65C816::jmp),
        ...
        OpCode::new(Meta::new(0x6a, "ROR", Implied), W65C816::ror_a),
        ...
        OpCode::new(Meta::new(0xdc, "JML", AbsoluteJMP), W65C816::jml),
